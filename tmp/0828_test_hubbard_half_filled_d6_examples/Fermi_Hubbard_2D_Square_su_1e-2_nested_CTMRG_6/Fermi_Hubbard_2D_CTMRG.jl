...
peps_param_str = "iter5853"*"_δτ0.01"
ctmrg_iter = 100
load_env = "random"
...
run_CTMRG_Square_Hubbard(t, U, μ, peps_filename, peps_param_str, 64, ctmrg_iter; load_env=load_env)
run_CTMRG_Square_Hubbard(t, U, μ, peps_filename, peps_param_str, 80, ctmrg_iter; load_env=load_env)
